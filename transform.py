...
cobranca_pacientes = pd.read_csv('inpatientCharges.csv')
print(cobranca_pacientes.head())
cobranca_pacientes[' Average Covered Charges '] = cobranca_pacientes[' Average Covered Charges '].str.replace('$', '',regex=False)
cobranca_pacientes[' Average Total Payments '] = cobranca_pacientes[' Average Total Payments '].str.replace('$', '',regex=False)
cobranca_pacientes['Average Medicare Payments'] = cobranca_pacientes['Average Medicare Payments'].str.replace('$', '',regex=False)

diagnosticos = pd.read_csv('datasets_180_408_data.csv')
